...
4. YOLO style (download and execute artifact via shell)
...
The overhead of having to setup a Go environment makes `go run main.go` the slowest, but if you need the Go tools anyway,
